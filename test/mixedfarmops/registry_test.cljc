...
(deftest yield-non-positive-test
  (testing "Positive yield is valid"
    (is (false? (registry/yield-non-positive? 12.5))))

  (testing "Zero yield is invalid"
    (is (true? (registry/yield-non-positive? 0))))

  (testing "Negative yield is invalid"
    (is (true? (registry/yield-non-positive? -3)))))

(deftest herd-count-non-positive-test
  (testing "Positive count is valid"
    (is (false? (registry/herd-count-non-positive? 30))))
