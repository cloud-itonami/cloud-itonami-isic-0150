# Operator Quickstart — Mixed-Farming Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0150** (`cloud-itonami-isic-0150`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0150.git
cd cloud-itonami-isic-0150
```
...
- Blueprint governor key: `mixed-farming-operations-governor`
- Likely source path: `mixedfarmops.governor.cljc`
